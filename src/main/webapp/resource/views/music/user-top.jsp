...
<body>
	<nav class="navbar navbar-default navbar-fixed-top">
			<div class="brand">
				<a href="<%=basePath%>/resource/views/music/user-play.jsp"><img src="<%=basePath%>/resource/views/music/assets/img/logo-dark.png" alt="Klorofil Logo" class="img-responsive logo"></a>
			</div>
