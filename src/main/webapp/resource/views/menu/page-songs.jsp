				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
							<div class="row row1">
								<jsp:include page="${basePath}/resource/views/songs/songs-index.jsp" flush="true" />
							</div>
							<div class="row">
								<form  action="<%=basePath%>/songs/loadSong" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<input id="song" type="file" class="form-control" name="myFile" onchange="test()"></br>
									</div>
