				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<p class="panel-subtitle">Date:${date} | All users</p>
						</div>
						<form class="navbar-form navbar-left" action="<%=basePath%>/resource/views/user/page-like.jsp">
							<div class="input-group">
								<input type="text" name="cName" value="" class="form-control" placeholder="Search user's name..."> <span class="input-group-btn"><button type="submit" class="btn btn-primary">Go</button></span>
							</div>
						</form>
						<div class="panel-body">
							<div class="row row1">
								<jsp:include page="${basePath}/resource/views/user/user-index.jsp" flush="true" />
							</div>
							<div class="row">
							</div>
							<div class="row">
