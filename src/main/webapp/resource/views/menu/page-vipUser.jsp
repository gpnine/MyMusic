				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">查看vip用户</h3>
							<p class="panel-subtitle">Date:${date} | vip users</p>
						</div>
						<form class="navbar-form navbar-left" action="<%=basePath%>/resource/views/user/vip-like.jsp">
							<div class="input-group">
								<input type="text" name="cName" value="${cName}" class="form-control" placeholder="Search vip"> <span class="input-group-btn"><button type="submit" class="btn btn-primary">Go</button></span>
							</div>
						</form>
						<div class="panel-body">
							<div class="row row1">
								<jsp:include page="${basePath}/resource/views/user/vip-index.jsp" flush="true" />
							</div>
							<div class="row">
							</div>
							<div class="row">
