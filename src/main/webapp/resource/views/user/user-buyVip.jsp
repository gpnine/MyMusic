				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
							<div class="row row1">
								<div class="buyVip-page">
									<div class="vipBig">至尊豪华VIP</div>
									<div class="vipSmall">享受优质音乐</div>
									<div class="vipHref"><button class="btn-primary1" onclick="javascript:window.location.href='<%=basePath%>/user/buyVip?phone=${phone}'">立即开通</button></div>
									<div class="vipMsg"><div class="${msgclass}">${msg}</div></div>
								</div>
							</div>
							<div class="row">
							</div>
