				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<p class="panel-subtitle">Date:${date} | User Index</p>
						</div>
						<form class="navbar-form navbar-left" action="<%=basePath%>/resource/views/user/page-like.jsp">
							<div class="input-group">
								<input type="text" name="cName" value="${cName}" class="form-control" placeholder="Search user"> <span class="input-group-btn"><button type="submit" class="btn btn-primary">Go</button></span>
							</div>
						</form>
						<div class="panel-body">
							<div class="row row1">
								...
								<jsp:include page="${basePath}/resource/views/user/userLike.jsp" flush="true" />
							</div>
							<div class="row">
							</div>
							<div class="row">
