				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">用户菜单页</h3>
							<p class="panel-subtitle">Date:${date} | Menus Operator</p>
						</div>
						<div class="panel-body">
							<div class="row row1">
								<jsp:include page="${basePath}/resource/views/user/user-menus-index.jsp" flush="true" />
							</div>
							<div class="row">
								<form class="form-auth-small" action="<%=basePath%>/userCaidan/addMenu" method="post">
