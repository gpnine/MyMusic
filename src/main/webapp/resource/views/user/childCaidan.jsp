...
<%
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
			+ path;
%>
<title>HT | Music ChildCaidan</title>
<meta charset="utf-8">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">添加子菜单</h3>
							<p class="panel-subtitle">Date:${date} | Add childCaidan Operator</p>
						</div>
						<div class="panel-body">
							<div class="row row1">
								<form class="form-auth-small" action="<%=basePath%>/userCaidan/addChildMenu" method="post">
									<div class="form-group">
										<input type="hidden" name="pId" value="${userCaidan.getmId()}">
										<input type="text" class="form-control" name="addName" placeholder="请输入子菜单名" value="${addName}">
									</div>
