...
<%
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
			+ path;
%>
<title>HT | Music SongInfo.jsp</title>
<meta charset="utf-8">
				...
				<div class="panel panel-headline">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div class="metric">
									<form class="form-auth-small" action="<%=basePath%>/songs/updateSongs" method="post">
										<div class="form-group">
											<input type="hidden" name="sId" value="${song.getsId()}">
											<input type="text" class="form-control" name="title" placeholder="请输入歌名" value="${song.getTitle()}">
										</div>
										<div class="form-group">
											<input type="text" class="form-control" disabled  value="${song.getSrc()}">
										</div>
										<div class="form-group">
											<input type="text" class="form-control" name="singer" placeholder="请输入歌手名" value="${song.getSinger()}">
										</div>
