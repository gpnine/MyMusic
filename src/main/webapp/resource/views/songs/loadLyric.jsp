				...
				<div class="panel panel-headline">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								<div class="metric">
									<form class="form-auth-small" action="<%=basePath%>/songs/loadLyric" method="post" enctype="multipart/form-data">
										<div class="form-group">
											<input type="hidden" name="sId" value="<%=request.getParameter("sId")%>"> 
											上传歌词：<input id="lyric" type="file" name="lyric" onchange="test()">
										</div>
