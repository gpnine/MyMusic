				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<p class="panel-subtitle">Date:${date} | Songs Index</p>
						</div>
						<form class="navbar-form navbar-left" action="<%=basePath%>/resource/views/songs/user-page-like.jsp">
							<div class="input-group">
								<input type="text" name="title" value="${title}" class="form-control" placeholder="Search song's name..."> <span class="input-group-btn"><button type="submit" class="btn btn-primary">Go</button></span>
							</div>
						</form>
						<div class="panel-body">
							<div class="row row1">
								...
								<jsp:include page="${basePath}/resource/views/songs/songLike1.jsp" flush="true" />
							</div>
							<div class="row">
							</div>
							<div class="row">
